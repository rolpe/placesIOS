...
class FirstViewController: UIViewController, UIPageViewControllerDataSource {
    ...
    private let contentImages = ["MiamiPhoto1.jpg",
                                 "MiamiPhoto2.jpg",
                                 "MiamiPhoto3.jpg",
                                 "MiamiPhoto4.jpg"];
    ...
    private func createPageViewController() {
        ...
        let pageController = self.storyboard!.instantiateViewControllerWithIdentifier("PhotosController") as! UIPageViewController
